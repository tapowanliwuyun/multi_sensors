...
const string output_filename = "../src/imuFactorExampleResults.csv";
...
int main(int argc, char* argv[])
{
  ...
  // 定义previous状态量 和 prop状态量  在后续积分过程中使用
  ...
  while (file.good()) {
    ...
    if (type == 0) { // IMU measurement
      ...
      // Now optimize and compare results.  IMU积分后的状态作为initial_values
