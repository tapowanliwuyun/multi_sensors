...
void KeyFrame::computeWindowOrbPoint()
{
    ...
    {
        // ORB features
        //std::cout <<  "运行 computeWindowOrbPoint  USE_ORB" << std::endl;
        vector<uchar> status;
        cv::Ptr<cv::ORB> detector = cv::ORB::create(NUM_ORB_FEATURES, 1.2f, 8, 1);
        //std::cout <<  "运行 computeWindowOrbPoint  cv::ORB::create" << std::endl;
        // std::cout << orb_window_keypoints.size()  << std::endl;
        // std::cout << image_intensity.cols  << std::endl;
        // std::cout << image_intensity.rows << std::endl;
        // std::cout << MASK.cols  << std::endl;
        // std::cout << MASK.rows << std::endl;
        detector->detect(image_intensity, orb_window_keypoints, MASK);
        //std::cout <<  "运行 computeWindowOrbPoint  detector" << std::endl;
    ...
    //std::cout <<  "运行 computeWindowOrbPoint " << std::endl;
}
...
void KeyFrame::computeWindowBriefPoint()
{
    ...
    //std::cout <<  "运行 computeWindowBriefPoint " << std::endl;
}
...
void KeyFrame::computeSearchOrbPoint()
{
    ...
    //std::cout <<  "运行 computeSearchOrbPoint " << std::endl;
}
...
void KeyFrame::computeSearchBriefPoint()
{
    ...
    //std::cout <<  "运行 computeSearchBriefPoint " << std::endl;
}
...
void KeyFrame::computeBoWPoint()
{
    ...
    //std::cout <<  "运行 computeBoWPoint " << std::endl;
}
