...
FrontEndFlow::FrontEndFlow(ros::NodeHandle& nh) {
    ...
    lidar_to_imu_ptr_ = std::make_shared<TFListener>(nh, "imu_link", "velo_link");//Ti_l
...
bool FrontEndFlow::ReadData() {
    ...
    bool valid_imu = IMUData::SyncData(unsynced_imu_, imu_data_buff_, cloud_time);//使用线性插值IMU传感器数据点云数据对齐
...
bool FrontEndFlow::UpdateGNSSOdometry() {
    ...
    gnss_odometry_ *= lidar_to_imu_;//Tw_l = Tw_i * Ti_l
