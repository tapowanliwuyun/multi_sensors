...
bool FrontEnd::Update(const CloudData& cloud_data, Eigen::Matrix4f& cloud_pose) {
    ...
    cloud_pose = current_frame_.pose;//Tw_cl

    // 更新相邻两帧的相对运动
    step_pose = last_pose.inverse() * current_frame_.pose;//Tll_cl = Tll_w * Tw_cl
    predict_pose = current_frame_.pose * step_pose;//Tw_nl = Tw_cl * Tcl_nl
